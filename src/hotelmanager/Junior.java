 ...
 * @author shahr
 */
public class Junior extends Room
{
    final private double COST=125.0; 
    public Junior()
    {
        super();
    }
    public Junior(int roomnumber)
    {
        super(roomnumber);
    }
    //@Override
    ...
    public void occupyRoom(int roomnumber)throws IOException
    {
        ...
        FileWriter fw=new FileWriter("junior.txt",false);
